...
import com.pastillasCreator.pill_box.actividades.MostradorPastillas;
...
public class MostradorPastillasUiTest {

    @Rule
    public ActivityScenarioRule<MostradorPastillas> mostradorPastillasActivityScenarioRule = new ActivityScenarioRule<>(
            MostradorPastillas.class);
    ...
    public void testListViewPastillasDisplayed() {
        onView(withId(R.id.listViewPastillas)).check(matches(isDisplayed()));
    ...
    public void testListViewPastillasIsVisible() {
        onView(withId(R.id.listViewPastillas)).check(matches(withEffectiveVisibility(ViewMatchers.Visibility.VISIBLE)));
